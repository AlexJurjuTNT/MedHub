...
using MedHub_Backend.Service.Jwt;
...
{
    public async Task<Model.User> RegisterPatientAsync(Model.User user)
    {
    ...
    public async Task<Model.User> RegisterDoctorAsync(Model.User user)
    {
        var userByUsername = await userService.GetUserByUsernameAsync(user.Username);
    ...
    public async Task<Model.User> RegisterAdminAsync(Model.User user)
    {
        var userByUsername = await userService.GetUserByUsernameAsync(user.Username);
    ...
    public async Task ResetPassword(Model.User existingUser, string password)
    {
