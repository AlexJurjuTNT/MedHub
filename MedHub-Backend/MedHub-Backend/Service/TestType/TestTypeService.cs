...
{
    public async Task<List<Model.TestType>> GetAllTestTypesAsync()
    {
        return await appDbContext.TestTypes.ToListAsync();
    }

    public async Task<Model.TestType?> GetTestTypeByIdAsync(int testTypeId)
    {
        return await appDbContext.TestTypes.FindAsync(testTypeId);
    }

    public async Task<Model.TestType> CreateTestTypeAsync(Model.TestType testType)
    {
    ...
    public async Task<Model.TestType> UpdateTestTypeAsync(Model.TestType testType)
    {
    ...
    public async Task<List<Model.TestType>> GetTestTypesFromIdList(List<int> testTypesIds)
    {
