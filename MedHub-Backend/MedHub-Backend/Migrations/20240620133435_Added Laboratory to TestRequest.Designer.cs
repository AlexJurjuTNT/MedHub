...
namespace MedHub_Backend.Migrations
{
    ...
    [Migration("20240620133435_Added Laboratory to TestRequest")]
    partial class AddedLaboratorytoTestRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedHub_Backend.Model.Laboratory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MedHub_Backend.Model.TestRequest", b =>
                {
                    ...
                    b.HasOne("MedHub_Backend.Model.Laboratory", "Laboratory")
                        .WithMany()
            ...
            modelBuilder.Entity("MedHub_Backend.Model.TestType", b =>
                {
                    b.HasOne("MedHub_Backend.Model.Laboratory", null)
                        .WithMany("TestTypes")
                        .HasForeignKey("LaboratoryId");
