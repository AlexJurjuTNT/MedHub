...
namespace Medhub_Backend.Persistence.Migrations
{
    ...
    [Migration("20240628125839_Fixed Many-To-Many between TestType and TestResult")]
    partial class FixedManyToManybetweenTestTypeandTestResult
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medhub_Backend.Domain.Entities.PatientInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TestRequestTestType", b =>
                {
                    ...
                    b.ToTable("test_request_test_type", (string)null);
                });

            modelBuilder.Entity("TestResultTestType", b =>
                {
                    ...
                    b.HasKey("TestResultsId", "TestTypesId");

                    b.HasIndex("TestTypesId");

                    b.ToTable("test_result_test_type", (string)null);
                });
            ...
            modelBuilder.Entity("Medhub_Backend.Domain.Entities.PatientInformation", b =>
                {
                    b.HasOne("Medhub_Backend.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("Medhub_Backend.Domain.Entities.PatientInformation", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
