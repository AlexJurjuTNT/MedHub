...
namespace MedHub_Backend.Migrations
{
    ...
    [Migration("20240607070044_TestResult - renamed RequestId to TestRequestId")]
    partial class TestResultrenamedRequestIdtoTestRequestId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedHub_Backend.Model.TestResult", b =>
                {
                    b.HasOne("MedHub_Backend.Model.TestRequest", "TestRequest")
                        .WithOne("TestResult")
                        .HasForeignKey("MedHub_Backend.Model.TestResult", "TestRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
